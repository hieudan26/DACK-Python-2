...
#===========================End label NVname=========================
    ...
    def Delete(self):
        if(self.checkIDNhanVien() == False):
            ...
            messagebox.showinfo("Add Nhân Viên", "Xoa Nhan Vien Thanh Cong", parent = self.Editroot)
        else:
            messagebox.showerror("Add Nhân Viên", "Lỗi: ID nhân viên không tồn tại", parent = self.Editroot)
        ...
        if (self.checkTT() == True):
            if(self.checkGioiTinh() == True):
                if(self.checkIDNhanVien() == True):
                    ...
                    messagebox.showinfo("Add Nhân Viên", "Thêm nhân viên thành công", parent = self.Editroot)
                else:
                     messagebox.showerror("Add Nhân Viên", "Lỗi: ID nhân viên đã tồn tại", parent = self.Editroot)
            else:
                messagebox.showerror("Add Nhân Viên", "Lỗi: Giới tính chỉ chấp nhận 'Nam' hoac 'Nữ' ", parent = self.Editroot)
        else:
            messagebox.showerror("Add Nhân Viên", "Không được để trông các mục", parent = self.Editroot)
        ...
        if (self.checkTT() == True):
            if(self.checkGioiTinh() == True):
                if(self.checkIDNhanVien() == False):
                    ...
                    messagebox.showinfo("Add Nhân Viên", "Sửa Nhân viên thành công", parent = self.Editroot)
                else:
                     messagebox.showerror("Add Nhân Viên", "Lỗi: Không tìm thấy nhân viên để sửa", parent = self.Editroot)
            else:
                messagebox.showerror("Add Nhân Viên", "Lỗi: Giới tính chỉ chấp nhận 'Nam' hoac 'Nữ'", parent = self.Editroot)
        else:
            messagebox.showerror("Add Nhân Viên", "Không được để trông các mục", parent = self.Editroot)
